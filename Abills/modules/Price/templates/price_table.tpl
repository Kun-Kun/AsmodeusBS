<script>
    ...
    function getUsersSum() {
        ...
        document.getElementById('total_sum').innerHTML = (Sum + TotalCheckbox + TotalDigit) + " <span class='glyphicon glyphicon-usd'></span>";
    }
    ...
    <div class='box box-primary'>
        ...
        <div class="box-body">
            <div class="form-group">
                ...
                <div class='col-md-2'>
                    <button class='btn btn-block btn-primary' type='submit' formnovalidate name='EMAIL_FORM'
            ...
            <div class='box-footer'>
                <div class='col-md-3'>
                    <button class='btn btn-block btn-primary' type=submit name='ACCEPT' value='_{CONFIRM}_'>
                        _{CONFIRM}_<span class='glyphicon glyphicon-ok'></span></button>
                </div>
                <div class='col-md-3'>
                    <button class='btn btn-block btn-primary' type=submit formnovalidate name='RES'
                            value='_{RESET}_'>_{RESET}_<span class='glyphicon glyphicon-refresh'></span></button>
                </div>
            </div>
            <!--End box footer, buttons-->
        </div>
        <!--End container-->
        <div id=menu>
            <h4>_{TOTAL}_:</h4>
            <h4 id="total_sum">0<span class='glyphicon glyphicon-usd'></span></h4>
        </div>
    </div>
    <!--Main box-->
</form>
